...
- インストレーション・プログラム (*アップグレードのみ/ライセンスキーが必要*)
  - **最新バージョン**
    - バージョン: **2.9.24.9.4** (2024-09-04)
    - ダウンロード: [nvr-2.9.24.9.4-emstone.iso](https://www.emstone.com/data/dvr/nvr-2.9.24.9.4-emstone.iso)
                / [SHA-256 Checksum](https://www.emstone.com/data/dvr/nvr-2.9.24.9.4-emstone.iso-sha256.txt)
    - モデル: 全モデル
- NVRバックアップ・ビデオ・プレーヤー
