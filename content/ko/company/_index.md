...
<script>
  function initBranchMap() {
    ...
    var branches = [
      ...
      {
        title: '경기서부',
        address: '경기도 안양시 동안구 시민대로 190',
        latlng: new naver.maps.LatLng(37.3909124, 126.9515756)
      },
      {
        title: '강릉지사',
...
**경기서부** | [경기도 안양시 동안구 시민대로 190](https://map.naver.com/v5/search/경기도+안양시+동안구+시민대로+190)
