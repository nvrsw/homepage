...
- 설치파일 (*업그레이드 전용 / 제품키 필요*)
  - **최신 버전**
    - 버전: **2.9.25.8.29** (2025-08-29)
    - 설치 파일: [nvr-2.9.25.8.29-emstone.iso](https://www.emstone.com/data/dvr/nvr-2.9.25.8.29-emstone.iso)
    / [SHA-256 Checksum](https://www.emstone.com/data/dvr/nvr-2.9.25.8.29-emstone.iso-sha256.txt)
    - 모델: 모든 모델
  <!--  - **EM-VMS1024**
